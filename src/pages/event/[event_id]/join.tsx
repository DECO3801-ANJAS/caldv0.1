...
const Join: NextPage = () => {
  ...
  const eventData = useSWR(
    router.isReady ? `/api/events/${router.query.event_id}` : null,
    fetcher,
  ...
  const handleSubmit = () => {
    ...
    if (joinDetails.name == "") {
      ...
      axiosFormData
        .post(`/api/events/${router.query.event_id}/participants`, data)
        .then((res) => {
          console.log(res);
          setOpen(true);
          setError(false);
      ...
      >
        ...
        >
          <ThemeProvider theme={textTheme}>
            <Typography fontFamily="sans-serif">NAME</Typography>
          </ThemeProvider>
        </Grid>
        <Grid
          item
        ...
        >
          <ThemeProvider theme={textTheme}>
            <Typography fontFamily="sans-serif">PICK A TASK</Typography>
          </ThemeProvider>
        </Grid>
        <Grid
          item
        ...
        >
          <ThemeProvider theme={textTheme}>
            <Typography fontFamily="sans-serif">EXPERIENCE</Typography>
          </ThemeProvider>
        </Grid>
        <Grid
          item
